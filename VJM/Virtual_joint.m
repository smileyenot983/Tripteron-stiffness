function [Kc] = Virtual_joint(T,T_base,T_tool,q,t,l_1,l_2,leg)
...
%     numerically computed Jacobian for leg 'x' w.r.t. parameters 'q'
    Jq = Jacobian_q1(T,T_base,T_tool,q,t,l_1,l_2);

%     numerically computed Jacobian for leg 'x' w.r.t. parameters 'theta'
    Jt = Jacobian_t1(T,T_base,T_tool,q,t,l_1,l_2);
...
if leg=='z'
    Jq = Jacobian_q2(T,T_base,T_tool,q,t,l_1,l_2);

    % Here we can use the same strange math to obtain Jacobian_theta
    Jt = Jacobian_t2(T,T_base,T_tool,q,t,l_1,l_2);
...
if leg =='y'
    Jq = Jacobian_q3(T,T_base,T_tool,q,t,l_1,l_2);

    % Here we can use the same strange math to obtain Jacobian_theta
    Jt = Jacobian_t3(T,T_base,T_tool,q,t,l_1,l_2);
